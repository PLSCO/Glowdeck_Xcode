...
else ifeq ($(UPLOADER),GlowdeckUp)
#	 Glowdeck uploader in charge
...
# ~~
        ...
        PLATFORM_VERSION = "1.6.11"
        #$(shell cat $(APPLICATION_PATH)/lib/version.txt)
    endif
endif
endif
endif
...
ifeq ($(LDFLAGS),)
    LDFLAGS       = -Os -Wl,--gc-sections -mcpu=cortex-m4 -mthumb -Tmk20dx256msd.ld
endif

ifndef OBJCOPYFLAGS
    OBJCOPYFLAGS  = -O binary -S -R .eeprom
endif
...
# ----------------------------------
#
$(TARGET_ELF): 	$(OBJS) mk20dx256msd.ld
		@echo "---- Link ---- "
...
clean:
		...
		@echo "nil" > $(OBJDIR)/nil
		@echo "---- Clean ----"
		-@rm -f *.o *.d $(OBJDIR)/$(TARGET).elf $(OBJDIR)/$(TARGET).bin
