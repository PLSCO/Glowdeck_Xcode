...
#
#
# Last update: Apr 21, 2016 release 4.4.9
...
PLATFORM         := Microduino
BUILD_CORE       := avr
PLATFORM_TAG      = ARDUINO=10608 MICRODUINO EMBEDXCODE=$(RELEASE_NOW) ARDUINO_AVR_PRO ARDUINO_ARCH_AVR
...
APP_LIB_PATH     := $(APPLICATION_PATH)/hardware/Microduino/avr/libraries
