...
PLATFORM_VERSION := $(BUILD_CORE) $(INTEL_GALILEO_RELEASE) for Arduino $(ARDUINO_CC_RELEASE)

HARDWARE_PATH     = $(APPLICATION_PATH)/hardware/i586/$(INTEL_GALILEO_RELEASE)
TOOL_CHAIN_PATH   = $(APPLICATION_PATH)/tools/i586-poky-linux-uclibc/$(INTEL_I586_RELEASE)/i586/pokysdk/usr/bin/i586-poky-linux-uclibc
SYSROOT_PATH      = $(APPLICATION_PATH)/tools/i586-poky-linux-uclibc/$(INTEL_I586_RELEASE)/i586/i586-poky-linux-uclibc
OTHER_TOOLS_PATH  = $(APPLICATION_PATH)/tools/sketchUploader/$(INTEL_UPLOAD_RELEASE)
