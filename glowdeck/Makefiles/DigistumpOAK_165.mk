...
ESP_POST_COMPILE   = $(APPLICATION_PATH)/tools/esptool/$(DIGISTUMP_OAK_ESPTOOLS_RELEASE)/esptool
...
UPLOADER_PATH       = $(OTHER_TOOLS_PATH)/oakcli/$(DIGISTUMP_OAK_OAKCLI_RELEASE)
